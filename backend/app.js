...
//API 
app.use('/auth', authRouter); //카카오 로그인 URL
app.use('/users', userRoutes); //유저 목록 조회, 유저 추가, get 조회, post 추가, patch /update-score/:id 점수 업데이트
...
app.use('/posts', postRouter); //post add 게시글 추가, get / 게시글 목록 조회, delete /delete/:id, 폼 타입으로 요청 필요, /my-posts/:userId 내 게시물
